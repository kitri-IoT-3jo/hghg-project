...
COMMENT ON TABLE APPOINTMENT_MEMBER IS 'APPOINTMENT_MEMBER';

COMMENT ON COLUMN APPOINTMENT_MEMBER.member_table_id IS 'member_table_id';
COMMENT ON COLUMN APPOINTMENT_MEMBER.member_id IS 'user_id';
COMMENT ON COLUMN APPOINTMENT_MEMBER.appointment_id IS 'appointment_id';
COMMENT ON COLUMN APPOINTMENT_MEMBER.check_host IS 'check_host';
...
COMMENT ON COLUMN BOARD.create_date IS 'create_date';
COMMENT ON COLUMN BOARD.user_id IS 'user_id';
COMMENT ON COLUMN BOARD.board_enable IS 'board_enable';
...
COMMENT ON COLUMN COMMENT.written_date IS 'written_date';
COMMENT ON COLUMN COMMENT.comment_content IS 'comment_content';
COMMENT ON COLUMN COMMENT.comment_enable IS 'comment_enable';
...
COMMENT ON COLUMN RESTAURANT.restaurant_eval IS 'restaurant_eval';
COMMENT ON COLUMN RESTAURANT.restaurant_enable IS 'restaurant_enable';

COMMENT ON TABLE RESTAURANT_APPOINTMENT IS 'RESTAURANT_APPOINTMENT';

COMMENT ON COLUMN RESTAURANT_APPOINTMENT.appointment_id IS 'appointment_id';
COMMENT ON COLUMN RESTAURANT_APPOINTMENT.appointment_title IS 'appointment_title';
COMMENT ON COLUMN RESTAURANT_APPOINTMENT.appointment_date IS 'appointment_date';
COMMENT ON COLUMN RESTAURANT_APPOINTMENT.restaurant_id IS 'restaurant_id';
COMMENT ON COLUMN RESTAURANT_APPOINTMENT.max_people IS 'max_people';
COMMENT ON COLUMN RESTAURANT_APPOINTMENT.current_people IS 'current_people';
COMMENT ON COLUMN RESTAURANT_APPOINTMENT.appointment_enable IS 'appointment_enable';

COMMENT ON TABLE RESTAURANT_PHOTO IS 'RESTAURANT_PHOTO';

COMMENT ON COLUMN RESTAURANT_PHOTO.photo_id IS 'photo_id';
COMMENT ON COLUMN RESTAURANT_PHOTO.restaurant_id IS 'restaurant_id';

COMMENT ON TABLE USER IS 'USER';

COMMENT ON COLUMN USER.user_id IS 'user_id';
COMMENT ON COLUMN USER.user_pw IS 'user_pw';
COMMENT ON COLUMN USER.user_name IS 'user_name';
COMMENT ON COLUMN USER.user_nickname IS 'user_nickname';
COMMENT ON COLUMN USER.gender IS 'gender';
COMMENT ON COLUMN USER.birth_date IS 'birth_date';
COMMENT ON COLUMN USER.email_id IS 'email';
COMMENT ON COLUMN USER.email_domain IS 'email_domain';
COMMENT ON COLUMN USER.user_enable IS 'user_enable';
