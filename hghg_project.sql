...
CREATE UNIQUE INDEX XPKUSER ON HGHG_USER
(user_id   ASC);



ALTER TABLE HGHG_USER
...
CREATE UNIQUE INDEX XPKCOMMENT ON USER_COMMENT
(comment_id   ASC);
...
ALTER TABLE APPOINTMENT_MEMBER
	ADD (CONSTRAINT R_9 FOREIGN KEY (member_id) REFERENCES HGHG_USER (user_id));



ALTER TABLE BOARD
	ADD (CONSTRAINT R_1 FOREIGN KEY (user_id) REFERENCES HGHG_USER (user_id) ON DELETE SET NULL);
...
ALTER TABLE USER_COMMENT
	ADD (CONSTRAINT R_3 FOREIGN KEY (user_id) REFERENCES HGHG_USER (user_id) ON DELETE SET NULL);
...
BEGIN
    ...
    /* ERWIN_RELATION:CHECKSUM="00023a87", PARENT_OWNER="", PARENT_TABLE="RESTAURANT_APPOINTMENT"
    ...
    /* ERwin Builtin Trigger */
    /* HGHG_USER  APPOINTMENT_MEMBER on child insert restrict */
    /* ERWIN_RELATION:CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="HGHG_USER"
    CHILD_OWNER="", CHILD_TABLE="APPOINTMENT_MEMBER"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    ...
    SELECT count(*) INTO NUMROWS
      FROM HGHG_USER
      WHERE
        /* %JoinFKPK(:%New,HGHG_USER," = "," AND") */
        :new.member_id = HGHG_USER.user_id;
    IF (
      /* %NotnullFK(:%New," IS NOT NULL AND") */
    ...
    THEN
      raise_application_error(
        -20002,
        'Cannot insert APPOINTMENT_MEMBER because HGHG_USER does not exist.'
      );
    END IF;
...
BEGIN
  ...
  /* ERWIN_RELATION:CHECKSUM="00023db0", PARENT_OWNER="", PARENT_TABLE="RESTAURANT_APPOINTMENT"
    CHILD_OWNER="", CHILD_TABLE="APPOINTMENT_MEMBER"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_8", FK_COLUMNS="appointment_id" */
  SELECT count(*) INTO NUMROWS
  ...
  /* ERwin Builtin Trigger */
  /* HGHG_USER  APPOINTMENT_MEMBER on child update restrict */
  /* ERWIN_RELATION:CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="HGHG_USER"
    CHILD_OWNER="", CHILD_TABLE="APPOINTMENT_MEMBER"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_9", FK_COLUMNS="member_id" */
  ...
  THEN
    raise_application_error(
      -20007,
      'Cannot update APPOINTMENT_MEMBER because HGHG_USER does not exist.'
    );
  END IF;
...
BEGIN
    /* ERwin Builtin Trigger */
    /* HGHG_USER  BOARD on child insert set null */
    /* ERWIN_RELATION:CHECKSUM="0000e8ee", PARENT_OWNER="", PARENT_TABLE="HGHG_USER"
    ...
    UPDATE BOARD
      ...
      WHERE
        NOT EXISTS (
          SELECT * FROM HGHG_USER
            WHERE
              /* %JoinFKPK(:%New,HGHG_USER," = "," AND") */
              :new.user_id = HGHG_USER.user_id
        ) 
...
BEGIN
    /* ERwin Builtin Trigger */
    /* BOARD  USER_COMMENT on parent delete set null */
    /* ERWIN_RELATION:CHECKSUM="0000b5d7", PARENT_OWNER="", PARENT_TABLE="BOARD"
    CHILD_OWNER="", CHILD_TABLE="USER_COMMENT"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_6", FK_COLUMNS="board_id" */
    UPDATE USER_COMMENT
      SET
        /* %SetFK(USER_COMMENT,NULL) */
        USER_COMMENT.board_id = NULL
      WHERE
        /* %JoinFKPK(USER_COMMENT,:%Old," = "," AND") */
        USER_COMMENT.board_id = :old.board_id;
...
DECLARE NUMROWS INTEGER;
BEGIN
  /* BOARD  USER_COMMENT on parent update set null */
  /* ERWIN_RELATION:CHECKSUM="0001ef33", PARENT_OWNER="", PARENT_TABLE="BOARD"
    CHILD_OWNER="", CHILD_TABLE="USER_COMMENT"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_6", FK_COLUMNS="board_id" */
  IF
  ...
  THEN
    UPDATE USER_COMMENT
      SET
        ...
        USER_COMMENT.board_id = NULL
      WHERE
        /* %JoinFKPK(USER_COMMENT,:%Old," = ",",") */
        USER_COMMENT.board_id = :old.board_id;
  END IF;

  /* ERwin Builtin Trigger */
  /* HGHG_USER  BOARD on child update no action */
  /* ERWIN_RELATION:CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="HGHG_USER"
    CHILD_OWNER="", CHILD_TABLE="BOARD"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_1", FK_COLUMNS="user_id" */
  ...
  THEN
    raise_application_error(
      -20007,
      'Cannot update BOARD because HGHG_USER does not exist.'
    );
  END IF;
...
CREATE  TRIGGER  tD_HGHG_USER AFTER DELETE ON HGHG_USER for each row
-- ERwin Builtin Trigger
-- DELETE trigger on HGHG_USER 
DECLARE NUMROWS INTEGER;
BEGIN
    /* ERwin Builtin Trigger */
    /* HGHG_USER  BOARD on parent delete set null */
    /* ERWIN_RELATION:CHECKSUM="0002789b", PARENT_OWNER="", PARENT_TABLE="HGHG_USER"
    CHILD_OWNER="", CHILD_TABLE="BOARD"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_1", FK_COLUMNS="user_id" */
    UPDATE BOARD
    ...
    /* ERwin Builtin Trigger */
    /* HGHG_USER  USER_COMMENT on parent delete set null */
    /* ERWIN_RELATION:CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="HGHG_USER"
    CHILD_OWNER="", CHILD_TABLE="USER_COMMENT"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    ...
    UPDATE USER_COMMENT
      SET
        /* %SetFK(USER_COMMENT,NULL) */
        USER_COMMENT.user_id = NULL
      WHERE
        /* %JoinFKPK(USER_COMMENT,:%Old," = "," AND") */
        USER_COMMENT.user_id = :old.user_id;

    /* ERwin Builtin Trigger */
    /* HGHG_USER  APPOINTMENT_MEMBER on parent delete restrict */
    /* ERWIN_RELATION:CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="HGHG_USER"
    CHILD_OWNER="", CHILD_TABLE="APPOINTMENT_MEMBER"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_9", FK_COLUMNS="member_id" */
    ...
    THEN
      raise_application_error(
        -20001,
        'Cannot delete HGHG_USER because APPOINTMENT_MEMBER exists.'
      );
    END IF;
...
CREATE  TRIGGER tU_HGHG_USER AFTER UPDATE ON HGHG_USER for each row
-- ERwin Builtin Trigger
-- UPDATE trigger on HGHG_USER 
DECLARE NUMROWS INTEGER;
BEGIN
  /* HGHG_USER  BOARD on parent update set null */
  /* ERWIN_RELATION:CHECKSUM="0002d350", PARENT_OWNER="", PARENT_TABLE="HGHG_USER"
    CHILD_OWNER="", CHILD_TABLE="BOARD"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_1", FK_COLUMNS="user_id" */
  IF
  ...
  /* HGHG_USER  USER_COMMENT on parent update set null */
  /* ERWIN_RELATION:CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="HGHG_USER"
    CHILD_OWNER="", CHILD_TABLE="USER_COMMENT"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_3", FK_COLUMNS="user_id" */
  ...
  /* ERwin Builtin Trigger */
  /* HGHG_USER  APPOINTMENT_MEMBER on parent update restrict */
  /* ERWIN_RELATION:CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="HGHG_USER"
    CHILD_OWNER="", CHILD_TABLE="APPOINTMENT_MEMBER"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_9", FK_COLUMNS="member_id" */
  ...
  THEN
    ...
    THEN 
      raise_application_error(
        -20005,
        'Cannot update HGHG_USER because APPOINTMENT_MEMBER exists.'
      );
    END IF;
  END IF;
...
CREATE  TRIGGER tI_USER_COMMENT BEFORE INSERT ON USER_COMMENT for each row
-- ERwin Builtin Trigger
-- INSERT trigger on USER_COMMENT 
DECLARE NUMROWS INTEGER;
BEGIN
    /* ERwin Builtin Trigger */
    /* HGHG_USER  USER_COMMENT on child insert set null */
    /* ERWIN_RELATION:CHECKSUM="0001fae8", PARENT_OWNER="", PARENT_TABLE="HGHG_USER"
    CHILD_OWNER="", CHILD_TABLE="USER_COMMENT"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_3", FK_COLUMNS="user_id" */
    UPDATE USER_COMMENT
      ...
      WHERE
        ...
        /* %JoinPKPK(USER_COMMENT,:%New," = "," AND") */
         and USER_COMMENT.comment_id = :new.comment_id;

    /* ERwin Builtin Trigger */
    /* BOARD  USER_COMMENT on child insert set null */
...
CREATE  TRIGGER tU_USER_COMMENT AFTER UPDATE ON USER_COMMENT for each row
-- ERwin Builtin Trigger
-- UPDATE trigger on USER_COMMENT 
DECLARE NUMROWS INTEGER;
BEGIN
  /* ERwin Builtin Trigger */
  /* HGHG_USER  USER_COMMENT on child update no action */
  /* ERWIN_RELATION:CHECKSUM="0001eeaa", PARENT_OWNER="", PARENT_TABLE="HGHG_USER"
    CHILD_OWNER="", CHILD_TABLE="USER_COMMENT"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_3", FK_COLUMNS="user_id" */
  SELECT count(*) INTO NUMROWS
  ...
  THEN
    raise_application_error(
      -20007,
      'Cannot update USER_COMMENT because HGHG_USER does not exist.'
    );
  END IF;

  /* ERwin Builtin Trigger */
  /* BOARD  USER_COMMENT on child update no action */
  /* ERWIN_RELATION:CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="BOARD"
    CHILD_OWNER="", CHILD_TABLE="USER_COMMENT"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_6", FK_COLUMNS="board_id" */
  ...
  THEN
    raise_application_error(
      -20007,
      'Cannot update USER_COMMENT because BOARD does not exist.'
    );
  END IF;
